// =============================================================================
// DATA.JS - CONFIGURATION (V81 - CONFIGURATION AVANCEE DES PROGRAMMES)
// =============================================================================
...
// NOUVEAU : Configuration par défaut des programmes
// active: est-ce que la cloche sonne ?
// delay: attente au début (en secondes)
// cutoff: arrêt avant la fin (en secondes)
let PRESET_CONFIGS = {
    "MESSE": {
        1: { active: false, delay: 0, cutoff: 0 },
        2: { active: true,  delay: 0, cutoff: 0 },
        3: { active: true,  delay: 0, cutoff: 0 },
        4: { active: true,  delay: 0, cutoff: 0 },
        5: { active: false, delay: 0, cutoff: 0 }
    },
    "MARIAGE": {
        1: { active: false, delay: 0, cutoff: 0 },
        2: { active: true,  delay: 0, cutoff: 0 },
        3: { active: true,  delay: 2, cutoff: 0 },
        4: { active: true,  delay: 4, cutoff: 0 },
        5: { active: true,  delay: 6, cutoff: 0 }
    },
    "BAPTEME": {
        1: { active: false, delay: 0, cutoff: 0 },
        2: { active: false, delay: 0, cutoff: 0 },
        3: { active: true,  delay: 0, cutoff: 0 },
        4: { active: true,  delay: 0, cutoff: 0 },
        5: { active: true,  delay: 0, cutoff: 0 }
    },
    "PLENUM": {
        1: { active: true,  delay: 0, cutoff: 0 },
        2: { active: true,  delay: 0, cutoff: 0 },
        3: { active: true,  delay: 0, cutoff: 0 },
        4: { active: true,  delay: 0, cutoff: 0 },
        5: { active: true,  delay: 0, cutoff: 0 }
    },
    // Note: Pour Angelus, Glas, etc. cela ne s'applique qu'à la partie "Volée" s'il y en a une.
    "ANGELUS": {
        1: { active: false, delay: 0, cutoff: 0 },
        2: { active: true,  delay: 0, cutoff: 0 }, // La cloche de volée de l'angelus par défaut
        3: { active: false, delay: 0, cutoff: 0 },
        4: { active: false, delay: 0, cutoff: 0 },
        5: { active: false, delay: 0, cutoff: 0 }
    }
};
...
const PRESET_NAMES = ["MESSE", "MARIAGE", "BAPTEME", "PLENUM", "ANGELUS", "GLAS", "TE_DEUM", "TOCSIN"]; // Liste simplifiée pour le menu config
...
const STATE = {
    ...
    // Variables pour l'éditeur de programmes
